...
export default function RegisterScreen({ navigation }) {
  ...
  return (
    <Screen3D style={s.container}>
      ...
      <FloatingOrb size={120} color={COLORS.primaryLight} x={W * 0.1} y={H * 0.1} delay={0} />
      <FloatingOrb size={80} color={COLORS.primary} x={W * 0.75} y={H * 0.2} delay={500} />
      <FloatingOrb size={60} color={COLORS.gold} x={W * 0.5} y={H * 0.05} delay={1000} />
...
const s = StyleSheet.create({
  ...
  bgOrb2: { position: "absolute", width: 300, height: 300, borderRadius: 150, backgroundColor: COLORS.gold, opacity: 0.03, top: H * 0.3, left: -120 },
  bgOrb3: { position: "absolute", width: 250, height: 250, borderRadius: 125, backgroundColor: COLORS.primaryLight, opacity: 0.02, bottom: H * 0.1, right: W * 0.15 },
  ...
  tagline: { fontSize: SIZES.sm, color: COLORS.muted, marginTop: SPACING.xs },
  ...
  eyeIcon: { fontSize: 16, color: COLORS.muted },

  btn: { height: 54, borderRadius: RADIUS.lg, backgroundColor: COLORS.primary, alignItems: "center", justifyContent: "center", marginTop: SPACING.xs, ...SHADOWS.primary, elevation: 10, overflow: "hidden" },
  ...
  loginCard: { backgroundColor: GLASS.bg, borderRadius: RADIUS.lg, padding: SPACING.md, alignItems: "center", borderWidth: 1, borderColor: COLORS.border },
  loginText: { color: COLORS.textSecondary, fontSize: SIZES.md },
  loginBold: { color: COLORS.gold, ...FONTS.bold },

  version: { color: COLORS.muted, fontSize: SIZES.xs, textAlign: "center", paddingBottom: SPACING.lg, marginTop: SPACING.lg },
});
